...
a = str(input("Deseja realizar uma multiplicação de matrizes? (S/N) ")).strip().lower()
...
if a == "s":
    for c in range(0, 3):
        if c == 0:
            for d in range(0, 3):
                valores = int(input(
                    f'\033[1mDigite um número para a posição\033[m \033[1;31m(\033[m\033[1;34m{c + 1}\033[m\033[1m,\033[m \033[1;34m{d + 1}\033[m\033[1;31m)\033[m\033[1m:\033[m '))
